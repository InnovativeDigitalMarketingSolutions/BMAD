...
class FigmaSlackNotifier:
        ...
        blocks = [
            {"type": "section", "text": {"type": "mrkdwn", "text": text}},
            {
                ...
                "elements": [
                    {
                        "type": "button",
                        "text": {"type": "plain_text", "text": "Bekijk Wijzigingen"},
        ...
        blocks = [
            {"type": "section", "text": {"type": "mrkdwn", "text": text}},
            {
                ...
                "elements": [
                    {
                        "type": "button",
                        "text": {"type": "plain_text", "text": "Bekijk Comments"},
                        "url": f"https://www.figma.com/file/{file_id}",
    ...
    def send_design_feedback_notification(self, feedback_data: Dict):
        ...
        text = (
            f"🎯 *Design Feedback Ontvangen*\n\n*{feedback_data.get('design_name', 'Unknown Design')}*\n\n"
            f"{feedback_data.get('feedback_text', '')}"
        )
        ...
        blocks = [
            {"type": "section", "text": {"type": "mrkdwn", "text": text}},
            {
                ...
                "elements": [
                    {
                        "type": "button",
                        "text": {"type": "plain_text", "text": "Reageer"},
        ...
        blocks = [
            {"type": "section", "text": {"type": "mrkdwn", "text": text}},
            {
                ...
                "elements": [
                    {
                        "type": "button",
                        "text": {"type": "plain_text", "text": "Bekijk Code"},
