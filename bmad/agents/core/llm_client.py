...
def ask_openai(prompt, model="gpt-4", temperature=0.7, max_tokens=512, structured_output=None):
    """
    ...
    :param model: Modelnaam (str, default 'gpt-4')
    ...
    logging.info(f"[LLM][REQUEST] {prompt[:60]}...")
